...
_get__('router').post('/login', _get__('passport').authenticate('local'), _get__('authController').login);
_get__('router').delete('/logout', _get__('authController').logout);
_get__('router').get('/currentUser', _get__('authController').getCurrentUser);
...
function _get_original__(variableName) {
  switch (variableName) {
    ...
    case 'authController':
      return _filterWildcardImport__(authController);
  }
